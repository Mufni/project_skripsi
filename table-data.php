          ...
          <nav class="cyan">
              <div class="nav-wrapper">
                  ...
                  <ul class="right hide-on-med-and-down">
                    <!-- Dropdown Trigger -->
                    <li><a href="#" data-activates="chat-out" class="waves-effect waves-block waves-light chat-collapse"><i class="mdi-action-input tooltipped" data-tooltip="Logout"></i></a>
