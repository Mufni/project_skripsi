...
<head>
    ...
    <title>Admin - Transportation Information System</title>
        ...
        <div class="navbar-fixed">
            <nav class="cyan">
                <div class="nav-wrapper">
                    <h1 class="logo-wrapper"><a href="{{URL::asset('admin/index.html')}}" class="brand-logo darken-1"></a> <span class="logo-text">Materialize</span></h1> <!--untuk membuat logo-->
                    <ul class="right hide-on-med-and-down">
                      <!-- Dropdown Trigger -->

                        <li><a href="#" data-activates="chat-out" class="waves-effect waves-block waves-light"><i class="mdi-action-input tooltipped" data-tooltip="Logout"></i></a>
